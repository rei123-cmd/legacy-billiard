...
try {
    ...
    while ($item = $cart_result->fetch_assoc()) {
        ...
        $total_grand += $total_harga;
        
        // Insert booking
        $booking_query = "INSERT INTO booking 
            (user_id, meja_id, nama_pemesan, telepon_pemesan, tanggal_booking, waktu_mulai, durasi_jam, paket_type, total_harga, voucher_code, diskon, status, payment_status, payment_method) 
    ...
    // Set success session for invoice
    $_SESSION['booking_success'] = true;
    $_SESSION['booking_ids'] = $booking_ids;
    $_SESSION['payment_method'] = $payment_method;
    $_SESSION['grand_total'] = $total_grand;
    
    // Redirect to invoice
    header('Location: invoice.php?booking_ids=' . implode(',', $booking_ids));
    exit;
